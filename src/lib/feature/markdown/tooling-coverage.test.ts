...
//
// src/lib/feature/markdown renders untrusted post and comment bodies. It spent a
...
const GUARDED_PATH = 'src/lib/feature/markdown'
const GUARDED_DIR = join(REPO_ROOT, 'src', 'lib', 'feature', 'markdown')
